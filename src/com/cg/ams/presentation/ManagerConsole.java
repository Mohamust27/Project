		...
		while (true) {
			...
			case 1:
				...
				if (allocationId > 0) {
					...
					System.out
							.println("Allocation request generated for employee number: "
									+ empId
									+ " with request id: "
									+ allocationbean.getAllocationId());
					adminFlag = 1;
				} else {
					System.out
							.println("Request can not be generated at the moment");
				}
			...
			case 2:
				...
				if (allocationId1 > 0) {
					...
					System.out
							.println("Deallocation request generated for employee number: "
									+ empId1
									+ " with request id: "
									+ allocationbean.getAllocationId());
					adminFlag = -1;
